...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { address: @home.address, description: @home.description, name: @home.name, price: @home.price } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { address: @home.address, description: @home.description, name: @home.name, price: @home.price } }
